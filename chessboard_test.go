...
func Test_different_combinations(t *testing.T) {
	...
	tests := []struct {
		...
		{"Test empty board with 2 rook 2 king", args{board: NewChessboard().withRook(2).withKing(2).Build()}, 657390},
...
func Test_queen_combinations(t *testing.T) {
	...
	tests := []struct {
		...
		{"Test empty board with 8 queen (mixed calls)", args{board: NewChessboard().withQueen(1).withQueen(1).withQueen(1).withQueen(1).withQueen(1).withQueen(1).withQueen(1).withQueen(1).Build()}, 92},
